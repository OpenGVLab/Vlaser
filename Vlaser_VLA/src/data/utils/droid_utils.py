...
# n', '_traj_index', '_frame_index'])
    ...
    for start in range(0, 1):
        ...
        wrist_image = trajectory["observation"]["wrist_image_left"][start:-stride-start]
        img1_list.append(img1)
        img2_list.append(img2)
        wrist_list.append(wrist_image)
    ...
    trajectory["observation"]["wrist_image"] = tf.concat(wrist_list, axis = 0)
