...
def make_oxe_dataset_kwargs(
    ...
    if name == 'fractal20220817_data' and data_mix_length == 1:
        dataset_kwargs["standardize_fn"] = ModuleSpec.create(
            OXE_STANDARDIZATION_TRANSFORMS['fractal20220817_data_orig']
        )
    else:
        dataset_kwargs["standardize_fn"] = ModuleSpec.create(
        ...
        try:
            data_kwargs_list.append(
                make_oxe_dataset_kwargs(
                    ...
                    action_proprio_normalization_type,
                    skip_norm,
                    data_mix_length = data_mix_length
                )
            )
