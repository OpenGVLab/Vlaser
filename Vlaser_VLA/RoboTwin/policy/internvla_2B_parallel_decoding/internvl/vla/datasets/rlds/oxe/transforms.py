...
from internvl.vla.datasets.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
from internvl.vla.datasets.rlds.utils.data_utils import (
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "aloha_put_bottles_dustbin": aloha_dataset_transform,
    "aloha_stack_blocks_three": aloha_dataset_transform,
    "aloha_stack_bowls_three": aloha_dataset_transform,
    "aloha_handover_block": aloha_dataset_transform,
    "aloha_place_burger_fries": aloha_dataset_transform,
    "aloha_shake_bottle_horizontally": aloha_dataset_transform,
    "aloha_place_empty_cup": aloha_dataset_transform,
    "aloha_place_dual_shoes": aloha_dataset_transform,
    "aloha_shake_bottle": aloha_dataset_transform,
    "aloha_handover_mic": aloha_dataset_transform,
    ...
    "aloha_stamp_seal": aloha_dataset_transform,
    "aloha_press_stapler": aloha_dataset_transform,
    "aloha_place_phone_stand": aloha_dataset_transform,
    "aloha_pick_dual_bottles": aloha_dataset_transform,
    "aloha_lift_pot": aloha_dataset_transform,
    "aloha_turn_switch": aloha_dataset_transform,
    "aloha_click_bell": aloha_dataset_transform,
    "aloha_gs_put_bottles_dustbin": aloha_dataset_transform,
    "aloha_gs_stack_blocks_three": aloha_dataset_transform,
    "aloha_gs_stack_bowls_three": aloha_dataset_transform,
    "aloha_gs_place_empty_cup": aloha_dataset_transform,
    "aloha_gs_place_dual_shoes": aloha_dataset_transform,
}
