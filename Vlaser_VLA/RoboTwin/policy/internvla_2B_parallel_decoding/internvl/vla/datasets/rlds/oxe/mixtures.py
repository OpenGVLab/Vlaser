...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "aloha_challenge_cup_5_tasks": [
        ("aloha_place_dual_shoes", 1.0),
        ("aloha_place_empty_cup", 1.0),
        ("aloha_put_bottles_dustbin", 0.75),
        ("aloha_stack_blocks_three", 0.75),
        ("aloha_stack_bowls_three", 0.8),
    ],
    "aloha_robotwin_20_tasks": [
        ("aloha_put_bottles_dustbin", 2.0),
        ("aloha_stack_blocks_three", 2.0),
        ("aloha_stack_bowls_three", 2.0),
        ("aloha_handover_block", 1.0),
        ("aloha_place_burger_fries", 1.0),
        ("aloha_shake_bottle_horizontally", 1.0),
        ("aloha_place_empty_cup", 2.0),
        ("aloha_place_dual_shoes", 2.0),
        ("aloha_shake_bottle", 1.0),
        ("aloha_handover_mic", 1.0),
        ("aloha_move_can_pot", 1.0),
        ("aloha_place_container_plate", 1.0),
        ("aloha_move_pillbottle_pad", 1.0),
        ("aloha_stamp_seal", 1.0),
        ("aloha_press_stapler", 1.0),
        ("aloha_place_phone_stand", 1.0),
        ("aloha_pick_dual_bottles", 1.0),
        ("aloha_lift_pot", 1.0),
        ("aloha_turn_switch", 1.0),
        ("aloha_click_bell", 1.0),
        ("aloha_gs_put_bottles_dustbin", 2.0),
        ("aloha_gs_stack_blocks_three", 2.0),
        ("aloha_gs_stack_bowls_three", 2.0),
        ("aloha_gs_place_empty_cup", 2.0),
        ("aloha_gs_place_dual_shoes", 2.0),
    ],
