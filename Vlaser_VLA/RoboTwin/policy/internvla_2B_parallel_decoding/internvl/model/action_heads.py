...
from internvl.vla.constants import ACTION_DIM, ACTION_TOKEN_BEGIN_IDX, IGNORE_INDEX, NUM_ACTIONS_CHUNK, PROPRIO_DIM, STOP_INDEX
...
class L1RegressionActionHead(nn.Module):
    ...
    def predict_action(self, actions_hidden_states):
        ...
        # print(f"!!! DEBUG: rearranged_actions_hidden_states.shape: {rearranged_actions_hidden_states.shape}")
